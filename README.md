...
```bash
npm install npm i media-recorder-hooks zustand
```

```bash
yarn add npm i media-recorder-hooks zustand
```

```bash
pnpm add npm i media-recorder-hooks zustand
```
...
Durante o desenvolvimento deste projeto, me inspirei na implementação de vídeo/WebRTC do projeto [bolhadev.chat](https://github.com/brunocroh/bolhadev.chat) desenvolvido por Bruno Croh.
